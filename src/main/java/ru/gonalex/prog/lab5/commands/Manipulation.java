 ...
 * @version 1.0
 */
public class Manipulation extends Command {
    ...
    public Manipulation(String name, String description, String help) {
    ...
    public String getTypingDataDescription() {
        ...
        switch (counter) {
            ...
            case 8:
                return "Есть информация о доме (y|n|yes|no|да|нет)? ";
            case 9:
                return "House name: ";
            case 10:
                return "House year: ";
    ...
    public String setTypingData(String value) {
        ...
        switch (counter) {
            ...
            case 8: // есть информация о доме?
                ...
                if (value.equals("n") || value.equals("no") || value.equals("нет")) {
                    counter = 14; // заканчиваем вводить информацию
                    return "";
                }
                else if (value.equals("y") || value.equals("yes") || value.equals("да"))
                {
                    house = new House();
                    counter++;
                    break;
